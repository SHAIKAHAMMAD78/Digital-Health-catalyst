...
$sql = "SELECT * FROM diabaties_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - Diabaties Test Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Diabaties Test Appointments</h2>
