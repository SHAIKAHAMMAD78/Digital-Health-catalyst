...
$sql = "SELECT * FROM guthealth_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - Guthealth Test Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Gut Health Test Appointments</h2>
