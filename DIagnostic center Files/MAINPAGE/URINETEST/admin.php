...
$sql = "SELECT * FROM urine_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - Urine Test Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Urine Test Appointments</h2>
