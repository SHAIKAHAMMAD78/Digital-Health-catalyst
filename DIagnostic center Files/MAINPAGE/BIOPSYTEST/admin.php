...
$sql = "SELECT * FROM Biopsy_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - BiopsyTest Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Biopsy Test Appointments</h2>
