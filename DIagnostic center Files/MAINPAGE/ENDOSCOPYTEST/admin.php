...
$sql = "SELECT * FROM endoscopy_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - Endoscopy Test Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Endoscopy Test Appointments</h2>
