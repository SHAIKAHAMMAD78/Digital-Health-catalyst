...
$sql = "SELECT * FROM allergy_tests ORDER BY created_at DESC";
...
<head>
    ...
    <title>Admin Panel - Allergy Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Allergy Test Appointments</h2>
