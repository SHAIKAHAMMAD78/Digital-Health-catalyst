...
$sql = "SELECT * FROM pulmonary_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - Pulmonary Test Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Pulmonary Test Appointments</h2>
