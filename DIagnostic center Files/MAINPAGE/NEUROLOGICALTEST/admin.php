...
$sql = "SELECT * FROM neurology_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - Neurological Test Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Neurological Test Appointments</h2>
