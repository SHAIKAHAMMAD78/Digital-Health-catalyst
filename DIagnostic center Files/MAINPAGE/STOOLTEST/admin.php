...
$sql = "SELECT * FROM stool_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - Stool Test Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Stool Test Appointments</h2>
