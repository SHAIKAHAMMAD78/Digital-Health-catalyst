...
$sql = "SELECT * FROM blood_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - BloodTest Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Blood Test Appointments</h2>
