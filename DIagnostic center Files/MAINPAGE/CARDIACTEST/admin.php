...
$sql = "SELECT * FROM cardiac_tests ORDER BY created_at ASC";
...
<head>
    ...
    <title>Admin Panel - Cardiac Test Appointments</title>
...
<body>
    <div class="admin-container">
        <div class="page-header">
            <h2><i class="fas fa-allergies"></i> Cardiac Test Appointments</h2>
